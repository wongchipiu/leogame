...
面向 7-12 岁儿童的密室逃脱解密游戏，把数学、英语、语文、科学问题融入奥特曼变身、解谜、Boss 战的玩法循环中，让孩子在玩中学习。支持小学 1-6 年级难度自适应。
...
- **年级自适应**：小学 1-6 年级可选，每年级对应不同难度范围（1年级1-2星/3年级1-4星/6年级3-5星），题目随孩子成长
...
| feat | `3cc498e` | 答错重试 + 知识回顾 + 每日挑战 |
| feat | `d0766e6` | 年级选择(1-6年级)难度自适应 |
